/*
  ...
  - The values [THREAD_COMMENT] on the enum `ReportedEntity` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ReportedEntity_new" AS ENUM ('RAP', 'THREAD', 'RAP_COMMENT', 'WALL_COMMENT', 'RAP_REVIEW', 'REVIEW_REQUEST', 'FORUM_THREAD');
